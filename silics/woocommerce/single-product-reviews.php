				...
				/*	$comment_form = array(
						...
						'fields'               => array(
							'author' => '<div class="comment-form-author form-group">' .
										'<input id="author" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30" aria-required="true" class="form-control" placeholder="Your Name*" required /></div>',
							'email'  => '<div class="comment-form-email">' .
										'<input id="email" style="margin-bottom:15px;" name="email" type="email" value="' . esc_attr( $commenter['comment_author_email'] ) . '" size="30" aria-required="true" class="form-control" placeholder="Your Email*" required /></div>',
						),
						'label_submit'  => __( 'Submit', 'woocommerce' ),
						'logged_in_as'  => '',
						'comment_field' => '',
					...
					$comment_form['comment_field'] .= '<div class="comment-form-comment deal-btn" style="margin-bottom:15px;" >' . '<textarea id="comment" name="comment"  aria-required="true" class="form-control" placeholder="Your Review*" required></textarea></div>';
